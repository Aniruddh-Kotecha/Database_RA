...
class Page{
    ...
    Page(string matrixName, int pageIndex, bool flag);
    Page(string matrixName, int rowIndex, int colIndex);
    Page(string tableName, int pageIndex, vector<vector<int>> rows, int rowCount);
    Page(string tableName, int pageIndex, vector<vector<int>> rows, int rowCount, bool flag);
    
    vector<int> getRow(int rowIndex);
    vector<vector<int>> getRows();
    void setRows(vector<vector<int>> &rows);
    int getRowCount();
    
    void swapContent(Page &page);
    void swapColumns(Page &page, int i, int j);
    void writeMatrixPage();
    void writePage();
    void transposeBlockInternally();
